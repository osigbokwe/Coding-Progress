// BlackJackv2.cpp : Defines the entry point for the console application.
//
...
public:
	...
	Card(CardSuit suit = Card::SUIT_CLUB, CardRank rank = Card::RANK_2) : m_suit(suit), m_rank(rank) {};
